#include "Analysis/LNV.h"

Exclusion_LNV::Exclusion_LNV(Engine* TE, Engine::Current HornType, 
		     Detector *TB,
...
Exclusion_LNV::~Exclusion_LNV()
{
}

double Exclusion_LNV::Bisect(double S, double E)
{
...
bool Exclusion_LNV::FindInterval(double S, double &M, double E)
{
	std::list<double> ll;
...
double Exclusion_LNV::IsZero(std::list<double> &ll)
{
...
void Exclusion_LNV::Split(std::list<double> &ll)
{
	bool Ret = false;
...
double Exclusion_LNV::Function(double lu2)
{
	SetMix(lu2);
...
void Exclusion_LNV::SetMix(double lu2)
{
...
void Exclusion_LNV::SetThr(double T)
{
	Thr = T;
}
