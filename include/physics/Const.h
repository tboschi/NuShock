...
namespace Const
{
	...
	static const double MQuarkU   = 0.002;
	static const double MQuarkD   = 0.005;
	static const double MQuarkS   = 0.10;
	static const double MQuarkC   = 1.29;
	static const double MQuarkB   = 4.19;
	static const double MQuarkT   = 172.9;
