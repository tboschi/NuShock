...
set key invert samplen 4 spacing 3 width 0 height 0 
...
set label 8 "Type I" at 0.0600000, 3.00000e-09, 0.00000 left rotate by -5 back nopoint
unset arrow
...
GNUTERM = "qt"
x = 0.0
## Last datafile plotted: "ExpALL_T.dat"
plot "../Limits/linetable_TwoTwo_T.dat" u 1:2 w filledcurve not lc 6, \
     "../Limits/fulllinetable_TwoTwo_T.dat" w l lw 1 lc 6 not, \
     "../Limits/linetable_Weyl_T.dat" u 1:2 w filledcurve not lc 5, \
     "../Limits/typeI.dat" w filledcurve lc 7 not, \
     "../Limits/lim_charmUt.dat" w l not dt 4 lc 7 lw 2, \
     "../Limits/lim_delphiUt.dat" w l not dt 4 lc 2 lw 2, \
     "../Limits/linetable_Weyl_T.dat" u 1:2 w l not lc 5 lw 2 dt "_ ", \
