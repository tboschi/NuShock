...
set key at 0.0120000, 1.00000e-05 left center vertical Left reverse enhanced autotitle nobox
set key invert samplen 1.2 spacing 1.2 width 0 height 0 
set key maxcolumns 0 maxrows 0
set key noopaque
unset label
set label 1 "color{charm}CHARM" at 0.0750000, 0.100000, 0.00000 right norotate front textcolor rgb "#e51e10"  nopoint
set label 2 "color{nutev}DELPHI" at 0.750000, 0.0500000, 0.00000 left norotate front textcolor rgb "grey"  nopoint
...
GNUTERM = "qt"
x = 0.0
## Last datafile plotted: "d/ExpALL_T_d_U.dat"
plot "../Limits/linetable_Weyl_T.dat"	w filledcurve lc 5 not,\
      "../Limits/linetable_TwoTwo_T.dat"	w filledcurve lc 6 not,\
      "../Limits/fadetypeI.dat"	w l lw 2 lt rgb "#ff8080" not, \
      "../Limits/linetable_Weyl_T.dat"       w l lw 2 lc 5 dt 3 not,\
      "../Limits/fulllinetable_TwoTwo_T.dat" w l lw 2 lc 6 dt 3 not,\
      "../Limits/lim_charmUt.dat"  w l not dt 1 lc 7 lw 2,\
      "../Limits/lim_delphiUt.dat" w l not dt 1 lc rgb "#787878" lw 2,\
      "../Limits/lim_na62Ut.dat"	   w l t "NA62" lc 8 lw 2 dt 3,\
      "../Limits/lim_shipUt.dat"	   w l t "SHiP" lc 8 lw 2 dt 2,\
      "m/ExpALL_T_m_U.dat" w l lw 2 lc 1 t "DUNE",\
      "d/ExpALL_T_d_U.dat" w l lw 2 lc 1 dt 2 not
#    EOF
