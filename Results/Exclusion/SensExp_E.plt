...
set key at 0.0120000, 0.500000, 0.00000 left top vertical Right reverse enhanced autotitle nobox
...
set label 2 "CHARM" at 0.200000, 0.00100000, 0.00000 left norotate front textcolor rgb "#e51e10"  nopoint
set label 3 "Peak search" at 0.100000, 0.00500000, 0.00000 right norotate front textcolor rgb "#e69f00"  nopoint
...
GNUTERM = "qt"
x = 0.0
## Last datafile plotted: "ExpALL_E.dat"
plot "../Limits/linetable_Weyl_E.dat" u 1:2 w filledcurve not lc 5, \
     "../Limits/linetable_TwoTwo_E.dat" u 1:2 w filledcurve not lc 6, \
     "../Limits/typeI.dat" w filledcurve lc 7 not, \
     "../Limits/lim_peakUe.dat" w l not dt 4 lc 4 lw 2, \
     "../Limits/lim_ps191Ue.dat" w l not dt 4 lc 2 lw 2, \
     "../Limits/lim_ps191Ue.dat" w l not dt 4 lc 2 lw 2, \
     "../Limits/lim_charmUe.dat" w l not dt 4 lc 7 lw 2, \
     "../Limits/line_expall_e.dat" w l t "SBND" lc 8 lw 2, \
     "../Limits/fulllinetable_TwoTwo_E.dat" w l lw 1 lc 6 dt 2 not, \
     "../Limits/linetable_Weyl_E.dat" w l lw 2 lc 5 dt "_ " not, \
